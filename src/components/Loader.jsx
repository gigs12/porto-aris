    ...
    >
      ...
      <div className="ls-logo-wrap">
        ...
        <div className="ls-logo-text">
          M Aris Subyantoro<span className="ls-dot">.</span>
        </div>
        <div className="ls-tagline">Web Design · Web Developer · Design Graphics · Operator Videotron</div>
      </div>
