  ...
  return (
    <section id="home" className="section hero">
      ...
      <div className="hero-tag anim-left" style={{ "--d": "60ms" }}>
        ...
        Based in Bontang, Indonesia · Open for Work
      </div>
      <div className="hero-grid">
        <div className="hero-left">
          ...
          <p className="hero-sub anim-left" style={{ "--d": "380ms" }}>
            I'm <strong>M ARIS SUBYANTORO</strong>. I built a service network for the needs of the creative industry with GIGS VISUAL STUDIO, where I became the team leader in every project worked on by GIGS VISUAL STUDIO.
          </p>
          ...
          <div className="hero-socials anim-up" style={{ "--d": "700ms" }} aria-label="Social links">
            ...
            <a
              href="https://www.linkedin.com/in/m-aris-subyantoro-024bbb310//"
              target="_blank"
              rel="noopener noreferrer"
              className="hero-social"
            ...
            <a
              href="https://www.instagram.com/aris_gigs/"
              target="_blank"
              rel="noopener noreferrer"
              className="hero-social"
